...
def build_prompt_from_search_list(
    ...
    **kwargs,
    ...
    template_name = (
        f"{template_prefix}_prompt{'_citation' if auto_citation else ''}.txt"
    )
    template_path = Path(
        prompts_base_path, template_name
    )  # 确保 prompts_base_path 为 Path 类型
